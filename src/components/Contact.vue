<template>
    <section class="pb-14">
    <div class="max-w-screen-xl mx-auto px-4 text-gray-600 dark:text-white md:px-8">
        <div class="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
        <div class="max-w-lg space-y-3">
            <h2 class="text-4xl font-semibold color">CONTACT</h2>
            <p class="text-gray-800  dark:text-white text-3xl font-thin sm:text-4xl">
            ...
            <ul v-for="(contactMethod, index) in contactMethods" :key="index" class="mt-6 flex flex-wrap gap-x-10 gap-y-6 items-center">
                <li class="flex items-center gap-x-3">
                    <div class="flex-none text-gray-400" v-html="contactMethod.icon"></div>
 ...
 export default {
  data() {
    return {
            contactMethods: [
                {
                    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#FFFFFF" class="w-6 h-6">
                ...
                },
                {
                    icon: `<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg " class="w-6 h-6">
                                <path fill="#FFFFFF" d="M18.44 3.06H5.56a2.507 2.507 0 0 0-2.5 2.5v12.88a2.507 2.507 0 0 0 2.5 2.5h12.88a2.5 2.5 0 0 0 2.5-2.5V5.56a2.5 2.5 0 0 0-2.5-2.5Zm1.5 15.38a1.511 1.511 0 0 1-1.5 1.5H5.56a1.511 1.511 0 0 1-1.5-1.5V5.56a1.511 1.511 0 0 1 1.5-1.5h12.88a1.511 1.511 0 0 1 1.5 1.5Z"/>
                                <path fill="#FFFFFF" d="M6.376 10.748a1 1 0 1 1 2 0v6.5a1 1 0 0 1-2 0Z"/>
                                <circle cx="7.376" cy="6.744" r="1" fill="#FFFFFF"/>
                                <path fill="#FFFFFF" d="M17.62 13.37v3.88a1 1 0 1 1-2 0v-3.88a1.615 1.615 0 1 0-3.23 0v3.88a1 1 0 0 1-2 0v-6.5a1.016 1.016 0 0 1 1-1a.94.94 0 0 1 .84.47a3.609 3.609 0 0 1 5.39 3.15Z"/>
                            </svg>`,
